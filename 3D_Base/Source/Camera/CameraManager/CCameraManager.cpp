	...
	, m_mProj			()
{
	...
	m_LastCamera[0] = { D3DXVECTOR3(0.f, 13.f, 0.f), D3DXVECTOR3(0.f, 1.f, 9.f) };
	m_LastCamera[1] = { D3DXVECTOR3(0.f, 14.f, -3.f), D3DXVECTOR3(0.f, 1.f, 9.f) };
	m_LastCamera[2] = { D3DXVECTOR3(0.f, 16.f, -6.f), D3DXVECTOR3(0.f, 1.f, 6.f) };
	m_LastCamera[3] = { D3DXVECTOR3(0.f, 20.f, -10.f), D3DXVECTOR3(0.f, 1.f, 6.f) };
}
