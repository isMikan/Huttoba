...
public:
    ...
    *****************************************************************************************/
    ...
    void SetLocalOffsetToSphere(D3DXVECTOR3& offset)  { m_LocalOffset = offset; }
    ...
    * @brief    カプセルの回転を設定
    *****************************************************************************************/
    void SetRotationCapsule(float Yaw, float Pitch, float Roll);
    void SetRotationXCapsule(float rad);
