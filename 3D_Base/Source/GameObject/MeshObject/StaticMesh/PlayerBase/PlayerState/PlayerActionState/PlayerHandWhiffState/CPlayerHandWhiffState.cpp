...
void CPlayerHandWhiffState::Enter(CPlayerBase& pPlayerBase)
{
...
void CPlayerHandWhiffState::Exit(CPlayerBase& pPlayerBase)
{
	pPlayerBase.SetStopping(false);
	pPlayerBase.SetAttacking(false);
}

void CPlayerHandWhiffState::Update(CPlayerBase& pPlayerBase)
{
